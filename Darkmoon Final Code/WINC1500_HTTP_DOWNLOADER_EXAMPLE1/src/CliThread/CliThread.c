...
static const CLI_Command_Definition_t xImuAccCommand = {"acc", "acc: Returns the value from Accelerometer(LIS2DH12)\r\n", (const pdCOMMAND_LINE_CALLBACK)CLI_GetAccData, 0};
	
static const CLI_Command_Definition_t xMaxCommand = {"max", "max: Returns the value from Heart rate click(max30102)\r\n", (const pdCOMMAND_LINE_CALLBACK)CLI_GetMaxData, 0};

static const CLI_Command_Definition_t xImuListmpCommand = {"listmp", "listmp: Returns the temperature from Accelerometer(LIS2DH12)\r\n", (const pdCOMMAND_LINE_CALLBACK)CLI_GetListmpData, 0};
