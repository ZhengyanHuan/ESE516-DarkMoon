...
/** Wi-Fi AP Settings. */
//#define MAIN_WLAN_SSID "Watsom:)"             /**< Destination SSID. Change to your WIFI SSID */
//#define MAIN_WLAN_SSID "watiPhone"  
#define MAIN_WLAN_SSID "Rain"  
#define MAIN_WLAN_AUTH M2M_WIFI_SEC_WPA_PSK /**< Security manner */
//#define MAIN_WLAN_PSK "Eff1$$uff"            /**< Password for Destination SSID. Change to your password. Please dont hack my WiFi router */
//#define MAIN_WLAN_PSK "13246578" 
#define MAIN_WLAN_PSK "zxcvbnma"
/** IP address parsing. */
#define IPV4_BYTE(val, index) ((val >> (index * 8)) & 0xFF)

/** Content URI for download. */
#define MAIN_HTTP_FILE_URL "http://172.173.255.123/FW.bin"  ///< Change me to the URL to download your OTAU binary file from!
//#define MAIN_HTTP_FILE_URL "https://www.seas.upenn.edu/~edgarc/IoT.pdf"
...
#define Hr_TOPIC "Heartrate"       // Students to change to an unique identifier for each device! Game Data
#define Watch_TOPIC "Watch"
#define GAME_TOPIC_OUT "P2_GAME_ESE516_T0"      // Students to change to an unique identifier for each device! Game Data
#define IMU_TOPIC "Accelerometer"            // Students to change to an unique identifier for each device! IMU Data
...
// Cloud MQTT User
#define CLOUDMQTT_USER_ID "watsom"

// Cloud MQTT pASSWORD
#define CLOUDMQTT_USER_PASSWORD "Hive13246578"
